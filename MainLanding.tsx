...
import { 
  ...
  FileSpreadsheet, Bell, Smartphone, Shield, X, Plus,
  Phone, Instagram, MessageSquare, Receipt, Users, Landmark, Lock, Cloud,
  BarChart3, UserCheck, Settings2, Building2, ClipboardList, Gem
} from 'lucide-react';
...
const MainLanding: React.FC<MainLandingProps> = ({ onGetStarted }) => {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center bg-slate-900 overflow-hidden px-6 text-center">
        ...
        >
          ...
          <h1 className="text-6xl md:text-[7rem] font-black text-white tracking-tighter leading-[0.85] mb-8">
            Manage with <span className="text-emerald-500">Absolute</span> Clarity.
          </h1>
          ...
          <button 
            ...
            className="group relative px-12 py-6 bg-emerald-600 text-white text-xl font-black rounded-3xl shadow-[0_20px_50px_rgba(16,185,129,0.4)] hover:bg-emerald-500 hover:scale-105 active:scale-95 transition-all flex items-center gap-4 mx-auto overflow-hidden"
          >
      ...
      {/* 3. SECTION 1: THE GROWTH STRATEGY */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-xl text-slate-500 font-medium leading-relaxed">
              <strong>Growth isn’t just about adding properties; it’s about maintaining quality while increasing volume.</strong> Most property managers hit a ceiling when manual chaos overtakes their capacity. Zenflow provides the <strong>Digital Infrastructure</strong> that allows you to break through, moving from fragmented spreadsheets to automated precision.
            </p>
          </div>
            ...
            {[
              {
                ...
                content: "Centralized data reduces human error and frees up 40% of administrative time. By automating the mundane—like rent reconciliation and document filing—your team can focus on high-impact acquisition and strategy rather than chasing paper trails."
              },
              {
                icon: UserCheck,
                title: "Tenant Retention",
                content: "Professional portals and instant communication build profound trust, leading to longer leases and 2026-standard satisfaction. Tenants who feel heard and have access to seamless payment tools are 35% more likely to renew their leases."
              },
              {
                icon: BarChart3,
                title: "Financial Intelligence",
                content: "Real-time analytics allow you to see where your money is going before the month ends. Our financial engine tracks every shilling, providing predictive insights that help you optimize cash flow and identify underperforming assets instantly."
              }
            ].map((pillar, i) => (
              <motion.div 
                key={i}
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 font-medium leading-relaxed">
                    <strong>Always Free. Tenants can download the portal, pay rent via integrated STK Push, and chat with managers at zero cost.</strong> We believe removing friction for tenants is the fastest way to ensure 100% collection rates.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 flex flex-col justify-center gap-6">
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-[2.5rem] border border-white/10 group">
                ...
                <p className="text-slate-400 font-medium leading-relaxed">
                  By providing a premium, high-tech service to your tenants, you justify higher rent yields and drive long-term retention. <strong>You aren't just buying software; you're upgrading your property's total market value proposition.</strong>
                </p>
              </div>
            </div>
      ...
      {/* 7. SECTION 2: TRANSPARENT PRICING */}
      <section className="py-24 bg-white px-6">
          ...
          <div className="lg:w-1/2 w-full flex justify-center">
            ...
            >
              ...
              <div className="p-12 bg-white rounded-[3.4rem]">
                ...
                <button 
                  onClick={onGetStarted}
                  className="w-full py-6 bg-emerald-600 text-white text-xl font-black rounded-3xl shadow-[0_20px_40px_-10px_rgba(16,185,129,0.4)] hover:bg-emerald-700 active:scale-95 transition-all flex items-center justify-center gap-4 group"
                >
                  Get Started with the Digital Package
